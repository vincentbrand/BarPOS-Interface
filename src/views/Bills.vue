<template>
  ...
  <section class="content pt-3">
    <div class="container-fluid">
      <div class="row">
        <!-- single customer -->
        <div v-for="(item,idx) in billsList" :key='idx'>
          <!-- bills -->
          <div class="slot" v-if="item">
          ...
          <div class="slot" v-else>
            <div class="card d-card" @click="openBillsModal(idx)">
              <div class="card-body p-0">
                <div class="d-md-flex" style="line-height: 160px;">
